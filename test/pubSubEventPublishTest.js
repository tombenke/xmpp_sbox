...
describe('stanza.io PubSub workflow', function () {
    ...
    it('Admin should create a node, publish an item, and others should receive that', function (done) {
        ...
        async.series([
            ...
            function (cb) {
                admin.createNode('pubsub.rebels', 'Mission briefing', '', function (err, resp) {
                	if (err) {
            ...
            function (cb) {
                han.subscribeToNode('pubsub.rebels', 'Mission briefing', function (err, resp) {
            ...
            function (cb) {
                chewie.subscribeToNode('pubsub.rebels', 'Mission briefing', function (err, resp) {
            ...
            function (cb) {
            	...
            	admin.publish('pubsub.rebels', 'Mission briefing', item, function (err, resp) {
            		if (err) {
            ...
            function (cb) {
                han.unsubscribeFromNode('pubsub.rebels', 'Mission briefing', function (err, resp) {
            ...
            function (cb) {
                chewie.unsubscribeFromNode('pubsub.rebels', 'Mission briefing', function (err, resp) {
    ...
    after(function() {
    	admin.deleteNode('pubsub.rebels', 'Mission briefing', function (err, resp) {
